...
# pull_match_stats(emea_config_stage_1['swiss'])
# pull_match_stats(emea_config_stage_1['group_a'])
# pull_match_stats(emea_config_stage_1['group_b'])
# pull_match_stats(emea_config_stage_1['group_c'])
# pull_match_stats(emea_config_stage_1['group_d'])
# pull_match_stats(emea_config_stage_1['main_event'])
# pull_match_stats(emea_config_stage_2['swiss'])
...
pull_match_stats(emea_config_faceit_stage_1['round_robin'])
