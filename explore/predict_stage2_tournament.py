...
match_results = {
    ...
    'losers_round2_match1': build_match_result(seed8, seed3),
    'losers_round2_match2': build_match_result(seed4, seed7),

    'losers_semifinal': build_match_result(seed8, seed4),

}

print('EMEA Stage 2')
emea_results = sim_tournament(seed1, seed2, seed3, seed4, seed5, seed6, seed7, seed8, team_mwa_dict, num_sims, match_results)
emea_results.to_csv('./data/emea_sim_results.csv', index=False)
...
match_results = {
    ...
    'winners_semifinal1': build_match_result(seed1, seed4),
    'winners_semifinal2': build_match_result(seed3, seed2),

    'winners_final': build_match_result(seed3, seed1),

    'losers_round1_match1': build_match_result(seed8, seed5),
    'losers_round1_match2': build_match_result(seed6, seed7),

    'losers_round2_match1': build_match_result(seed8, seed2),
    'losers_round2_match2': build_match_result(seed4, seed6),

    'losers_semifinal': build_match_result(seed4, seed8),


}
print('NA Stage 2')
na_results = sim_tournament(seed1, seed2, seed3, seed4, seed5, seed6, seed7, seed8, team_mwa_dict, num_sims, match_results)
na_results.to_csv('./data/na_sim_results.csv', index=False)
